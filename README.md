...
In this project, I utilized the `yfinance` library to extract Tesla stock data and experimented with various prediction methods, including LSTM, ARIMA, and machine learning algorithms like linear regression. LSTM, known for its proficiency in analyzing long sequences of data, was tested for its efficacy in long-term forecasting using `tensorflow' library. 
